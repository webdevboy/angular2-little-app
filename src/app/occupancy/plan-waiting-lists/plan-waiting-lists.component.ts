...
export class PlanWaitingListsComponent implements OnInit, OnDestroy {
  ...
  constructor() {
    ...
    this.newChild = {id:"1",name:"", age:"", birthdate: "", officialStartdate:"",roomStartdate:"",roomEnddate:"", paperwork:false, assignedRoom:"0", movetoRoom: "0", movetoDate: "", parentName: "parent", parentEmail:"parent@mail.com", deposit:false,
